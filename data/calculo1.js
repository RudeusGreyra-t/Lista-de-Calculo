...
{materia:"Integrais", subtopico:"Integração direta", secId:"integrais", etapa: "P1", exercicios:[
  {id:"P1-OFI-004", numero: 4, origem:"Prova antiga", oficial:"⭐ P1 Oficial", dificuldade:"Fácil", relevancia:"Muito Alta",
   ...
   resposta:"$$\\int 2x^7 \\, dx = 2 \\frac{x^8}{8} + C = \\frac{x^8}{4} + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-DIR-001", origem:"Prova antiga", dificuldade:"Fácil", relevancia:"Alta",
   ...
   resposta: "$$x^3 - 2x^2 + 2x + C; \\; C \\in \\mathbb{R}$$"},
  ...
  {id:"INT-DIR-006", origem:"Listas de IA", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$2\\ln(x) + 3\\tan(x) - 2e^x + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-DIR-007", origem:"Dado em aula 18/08/2026", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$\\int x^{-3} \\, dx = \\frac{x^{-3+1}}{-3+1} + C = -\\frac{1}{2x^2} + C; \\; C \\in \\mathbb{R}$$"},
  ...
  {id:"INT-DIR-010", origem:"Listas de IA", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$\\frac{x^9}{9} - \\cos(x) - e^x + C; \\; C \\in \\mathbb{R}$$"}
]},
{materia:"Integrais", subtopico:"Substituição simples", secId:"integrais", etapa: "P1", exercicios:[
  {id:"P1-OFI-005", numero: 5, origem:"Prova antiga", oficial:"⭐ P1 Oficial", dificuldade:"Médio", relevancia:"Muito Alta",
   ...
   resposta:"Utilizando o método da substituição, seja \\( u = x^4 \\). Derivando, temos \\( du = 4x^3 \\, dx \\).<br><br>Substituindo na integral:<br>$$\\int \\cos(u) \\, du = \\sin(u) + C$$<br>Voltando para a variável original:<br>$$\\sin(x^4) + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-SUB-001", origem:"Prova antiga", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$\\sin(x^2) + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-SUB-002", origem:"Dado em aula 18/08/2026", dificuldade:"Fácil", relevancia:"Alta",
   ...
   resposta: "$$\\frac{\\sin(2x)}{2} + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-SUB-003", origem:"Dado em aula 18/08/2026", dificuldade:"Fácil", relevancia:"Alta",
   ...
   resposta: "$$\\frac{e^{4x}}{4} + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-SUB-004", origem:"Gerado a partir das listas Lista 3", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$\\sin(3x^2) + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-SUB-005", origem:"Aula de revisão", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$-\\frac{1}{3}\\cos(x^3) + C; \\; C \\in \\mathbb{R}$$"},
  ...
  {id:"INT-SUB-008", origem:"Listas de IA", dificuldade:"Fácil", relevancia:"Média",
   ...
   resposta: "$$-\\frac{1}{5}\\cos(5x) + C; \\; C \\in \\mathbb{R}$$"},
  {id:"INT-SUB-009", origem:"Listas de IA", dificuldade:"Médio", relevancia:"Alta",
   ...
   resposta: "$$-\\cos(4x^2) + C; \\; C \\in \\mathbb{R}$$"},
