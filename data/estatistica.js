    ...
    // ==========================================
    {
      ...
      exercicios: [
        ...
        },
        {
          ...
          dificuldade: "Médio",
          relevancia: "Alta",
          enunciado: `Do conjunto de valores observados abaixo, calcule a mediana e moda para cada grupo.`,
          resposta: ``,
          itens: [
            { id: "A", enunciado: `a) \\( X = \\{3, 5, 8, 4, 8, 6\\} \\)`, resposta: `Rol: 3, 4, 5, 6, 8, 8 (\\( n = 6 \\), par).<br>\\( Md = \\frac{5+6}{2} = 5,5 \\)<br>\\( Mo = 8 \\)` },
            { id: "B", enunciado: `b) \\( Y = \\{3, 6, 8, 8, 6, 6, 10, 20, 12\\} \\)`, resposta: `Rol: 3, 6, 6, 6, 8, 8, 10, 12, 20 (\\( n = 9 \\), ímpar).<br>\\( Md = 8 \\)<br>\\( Mo = 6 \\)` }
          ]
        },
        {
          id: "PDF-005",
        ...
        },
        {
          ...
          dificuldade: "Médio",
          relevancia: "Alta",
          enunciado: `Cinco pessoas usaram dois instrumentos para indicar o nível de dor 12 horas após uma operação. A seguir estão os escores de dor de cada pessoa, em cada instrumento:<br><br><table style='width:100%; border-collapse:collapse; background-color:var(--bg); text-align:center;'><tr style='background-color:rgba(128,128,128,0.1);'><th style='border:1px solid var(--border); padding:8px;'>Pessoa</th><th style='border:1px solid var(--border); padding:8px;'>A</th><th style='border:1px solid var(--border); padding:8px;'>B</th><th style='border:1px solid var(--border); padding:8px;'>C</th><th style='border:1px solid var(--border); padding:8px;'>D</th><th style='border:1px solid var(--border); padding:8px;'>E</th></tr><tr><td style='border:1px solid var(--border); padding:8px;'>Dor (Inst. 1)</td><td style='border:1px solid var(--border); padding:8px;'>8</td><td style='border:1px solid var(--border); padding:8px;'>6</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>3</td></tr><tr><td style='border:1px solid var(--border); padding:8px;'>Dor (Inst. 2)</td><td style='border:1px solid var(--border); padding:8px;'>9</td><td style='border:1px solid var(--border); padding:8px;'>7</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>6</td></tr></table>`,
          resposta: ``,
          itens: [
            { id: "A", enunciado: `a) Qual instrumento teve um escore, em média, de mais dor?`, resposta: `Inst 1: \\( \\bar{x}_1 = \\frac{25}{5} = 5 \\). Inst 2: \\( \\bar{x}_2 = \\frac{30}{5} = 6 \\) (Inst 2 teve média maior).` },
            { id: "B", enunciado: `b) Qual a mediana dos escores dos dois instrumentos?`, resposta: `Inst 1 rol: 3, 4, 4, 6, 8 \\( \\Rightarrow Md_1 = 4 \\). Inst 2 rol: 4, 4, 6, 7, 9 \\( \\Rightarrow Md_2 = 6 \\).` },
            { id: "C", enunciado: `c) Qual a moda dos escores dos dois instrumentos?`, resposta: `\\( Mo_1 = 4 \\), \\( Mo_2 = 4 \\).` }
          ]
        }
      ]
    },
      ...
      exercicios: [
        {
          ...
          resposta: ``,
          itens: [
            { id: "A", enunciado: `a) A afirmação do prefeito está correta? Explique sua resposta, criticando o uso isolado da média nesse contexto.`, resposta: `A afirmação está incorreta. A média aritmética é sensível a valores discrepantes (outliers). A contratação dos executivos gerou uma distorção positiva na média salarial. Essa elevação não representa a realidade, já que 95% da base teve reajustes abaixo da inflação.` },
            { id: "B", enunciado: `b) Cite uma medida de posição central que poderia ser usada em conjunto com os dados para oferecer uma análise mais fiel da realidade financeira da maioria dos trabalhadores. Justifique brevemente a sua escolha.`, resposta: `A <strong>Mediana</strong> (ou Moda). A mediana é uma medida de tendência central robusta e resistente à presença de valores atípicos. Ela representaria o salário do trabalhador típico da cidade.` }
          ]
        },
        {
          id: "PDF-004-B",
      ...
      exercicios: [
        {
          ...
          dificuldade: "Médio",
          relevancia: "Muito Alta",
          enunciado: `Considere os seguintes tempos (em minutos) que um grupo de estudantes levou para completar uma prova: 22, 24, 25, 27, 28, 29, 30, 31, 33, 35, 90.`,
          resposta: `O rol possui \\( n=11 \\) elementos.`,
          itens: [
            { id: "A", enunciado: `a) Identifique a mediana, os quartis, os limites inferior e superior e os possíveis outliers.`, resposta: `Mediana (\\( Q_2 \\)): 6º termo = 29.<br>Primeiro Quartil (\\( Q_1 \\)): Mediana da metade inferior {22, 24, 25, 27, 28} = 25.<br>Terceiro Quartil (\\( Q_3 \\)): Mediana da metade superior {30, 31, 33, 35, 90} = 33.<br>IQR = \\( 33 - 25 = 8 \\).<br>Limite Inferior = \\( Q_1 - 1,5 \\cdot IQR = 25 - 12 = 13 \\).<br>Limite Superior = \\( Q_3 + 1,5 \\cdot IQR = 33 + 12 = 45 \\).<br>Outliers: Como 90 > 45, o valor 90 é um outlier superior.` },
            { id: "B", enunciado: `b) Explique como o boxplot representa graficamente a presença de outliers nesse caso.`, resposta: `O valor 90 não é conectado à haste principal superior (que termina em 35, o maior valor não discrepante). Ele é plotado como um ponto isolado ou asterisco além da extremidade do bigode superior.` }
          ]
        },
        {
          id: "LISTA-Q14",
        ...
        },
        {
          ...
          dificuldade: "Difícil",
          relevancia: "Baixa",
          enunciado: `Duas turmas (A e B) realizaram uma prova (0 a 100).<br><strong>Turma A:</strong> 45, 48, 52, 55, 58, 60, 62, 65, 68, 70, 72, 75, 78, 80, 82, 85, 88, 90, 92, 95.<br><strong>Turma B:</strong> 30, 40, 55, 60, 62, 65, 68, 70, 71, 72, 73, 74, 75, 76, 78, 80, 82, 90, 95, 100.`,
          resposta: ``,
          itens: [
            { id: "A", enunciado: `a) Determine os 5 números-resumo de cada turma e o AIQ.`, resposta: `<strong>Turma A:</strong> Min=45; Q1=59; Med=71; Q3=83,5; Max=95. \\( AIQ = 24,5 \\).<br><strong>Turma B:</strong> Min=30; Q1=63,5; Med=72,5; Q3=79; Max=100. \\( AIQ = 15,5 \\).` },
            { id: "B", enunciado: `b) Verifique se existem valores atípicos (outliers) utilizando a regra do AIQ.`, resposta: `<strong>Turma A:</strong> Limites: [22,25 ; 120,25]. Não há outliers.<br><strong>Turma B:</strong> Limites: [40,25 ; 102,25]. Outliers: 30 e 40.` }
          ]
        }
      ]
    },
      ...
      exercicios: [
        {
          ...
          dificuldade: "Médio",
          relevancia: "Alta",
          enunciado: `Cinco pessoas, que se submeteram a uma mesma cirurgia no joelho, usaram dois instrumentos para indicar o nível de dor 12 horas após a operação. A seguir estão os escores de dor de cada pessoa, em cada instrumento. Com base nos dados, calcule para cada instrumento:<br><br><table style='width:100%; border-collapse:collapse; background-color:var(--bg); text-align:center;'><tr style='background-color:rgba(128,128,128,0.1);'><th style='border:1px solid var(--border); padding:8px;'>Pessoa</th><th style='border:1px solid var(--border); padding:8px;'>A</th><th style='border:1px solid var(--border); padding:8px;'>B</th><th style='border:1px solid var(--border); padding:8px;'>C</th><th style='border:1px solid var(--border); padding:8px;'>D</th><th style='border:1px solid var(--border); padding:8px;'>E</th></tr><tr><td style='border:1px solid var(--border); padding:8px;'>Dor (Inst. 1)</td><td style='border:1px solid var(--border); padding:8px;'>8</td><td style='border:1px solid var(--border); padding:8px;'>6</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>3</td><td style='border:1px solid var(--border); padding:8px;'>4</td></tr><tr><td style='border:1px solid var(--border); padding:8px;'>Dor (Inst. 2)</td><td style='border:1px solid var(--border); padding:8px;'>9</td><td style='border:1px solid var(--border); padding:8px;'>7</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>4</td><td style='border:1px solid var(--border); padding:8px;'>6</td></tr></table>`,
          resposta: `Para o Inst. 1: Média = 5, Moda = 4.<br>Para o Inst. 2: Média = 6, Moda = 4.`,
          itens: [
            { id: "A", enunciado: `a) Desvio médio.`, resposta: `Inst. 1: \\( dm(1) = 1,6 \\)<br>Inst. 2: \\( dm(2) = 1,6 \\)` },
            { id: "B", enunciado: `b) Variância.`, resposta: `Inst. 1: \\( V(1) = 4 \\)<br>Inst. 2: \\( V(2) = 4,5 \\)` },
            { id: "C", enunciado: `c) Desvio padrão.`, resposta: `Inst. 1: \\( \\sigma(1) = 2 \\)<br>Inst. 2: \\( \\sigma(2) = 2,12 \\)` },
            { id: "D", enunciado: `d) Coeficiente de variação. Interprete.`, resposta: `Inst. 1: \\(CV(1) = 40\\% \\)<br>Inst. 2: \\(CV(2) = 35,36\\% \\)<br><strong>Interpretação:</strong> O Instrumento 1 apresenta maior variabilidade relativa do que o Instrumento 2.` },
            { id: "E", enunciado: `e) Coeficiente de Assimetria.`, resposta: `Inst. 1: \\( \\Delta S_1 = \\frac{5 - 4}{2} = 0,5 \\)<br>Inst. 2: \\( \\Delta S_2 = \\frac{6 - 4}{2,1} = 0,95 \\)` }
          ]
        },
        {
          id: "LISTAP2-Q07",
          ...
          dificuldade: "Fácil",
          relevancia: "Média",
          enunciado: `O atributo X tem média amostral 20 e variância amostral 2,56. O atributo Y tem média amostral 45 e desvio padrão amostral 6,2.`,
          resposta: ``,
          itens: [
      ...
      exercicios: [
        {
          ...
          dificuldade: "Difícil",
          relevancia: "Alta",
          enunciado: `Um órgão do governo está interessado em determinar padrões sobre o investimento em educação, por habitante, realizado pelas prefeituras. De um levantamento de dez cidades, foram obtidos os valores: 20, 16, 14, 8, 19, 15, 14, 16, 19 e 18.<br><br>Será considerado como investimento básico a média final das observações calculada em três passos. Siga-os e determine o resultado final.`,
          resposta: ``,
          itens: [
            { id: "A", enunciado: `Passo 1. Obtém-se a média e o desvio padrão iniciais do conjunto.`, resposta: `\\( \\bar{x} = 15,9 \\)<br>Variância \\( v(x) = 12,32 \\) e Desvio Padrão \\( \\sigma_x = 3,51 \\).` },
            { id: "B", enunciado: `Passo 2. Eliminam-se do conjunto aquelas observações que forem superiores à média inicial mais duas vezes o desvio padrão, ou inferiores à média inicial menos duas vezes o desvio padrão.`, resposta: `Calculando o intervalo de aceitação \\([\\bar{x} - 2\\sigma_x ; \\bar{x} + 2\\sigma_x] \\):<br>\\([15,9 - 7,02 ; 15,9 + 7,02] = [8,88 ; 22,92] \\).<br>Deve-se excluir as cidades com investimentos fora desse intervalo. A única cidade que sai do estudo é a cidade com o valor 8.` },
            { id: "C", enunciado: `Passo 3. Calcula-se a média final (investimento básico) com o novo conjunto de observações.`, resposta: `Calculando a nova média sem o valor 8 (novo n = 9):<br>$$\\bar{x}_{final} = 16,8$$` }
          ]
        }
      ]
    },
      ...
      exercicios: [
        {
          ...
          dificuldade: "Fácil",
          relevancia: "Média",
          enunciado: `Suponha que as notas de um vestibular tenham distribuição normal com média 60 e desvio padrão de 15 pontos.`,
          resposta: ``,
          itens: [
            { id: "A", enunciado: `a) Se você prestou este vestibular e obteve nota igual a 40 pontos, qual a sua posição em termos de unidades de desvios padrão, com relação à média das notas?`, resposta: `$$Z = \\frac{40 - 60}{15} = -1,33 \\text{ desvios padrão}$$` },
            { id: "B", enunciado: `b) Se foram considerados aprovados os candidatos que obtiveram nota mínima correspondente a 1 desvio padrão acima da média, qual a nota mínima de aprovação na escala original?`, resposta: `$$60 + 1(15) = 75 \\text{ pontos}$$` },
            { id: "C", enunciado: `c) Se a nota mínima de aprovação foi de 2 desvios padrão acima da média, qual o valor na escala original?`, resposta: `$$60 + 2(15) = 90 \\text{ pontos}$$` },
            { id: "D", enunciado: `d) Se foi 2,5 desvios padrão acima da média, qual o valor?`, resposta: `$$60 + 2,5(15) = 97,5 \\text{ pontos}$$` },
            { id: "E", enunciado: `e) Se foram considerados reprovados os que obtiveram nota mínima correspondente a 0,5 desvios padrão abaixo da média, qual a nota de reprovação?`, resposta: `$$60 - 0,5(15) = 52,5 \\text{ pontos}$$` }
          ]
        }
      ]
    },
      ...
      exercicios: [
        {
          ...
          dificuldade: "Fácil",
          relevancia: "Alta",
          enunciado: `Um pesquisador coletou dados sobre o número de horas de estudo por semana (X) e as notas finais (Y, em escala de 0 a 10) de 4 alunos. Os pares ordenados (X, Y) são: Aluno 1 (2, 4); Aluno 2 (4, 6); Aluno 3 (6, 8); e Aluno 4 (8, 10).`,
          resposta: `Valores descritivos: \\( \\bar{x} = 5 \\), \\( \\bar{y} = 7 \\), \\( \\sum(x_i - \\bar{x})^2 = 20 \\), \\( \\sum(y_i - \\bar{y})^2 = 20 \\), \\( \\sum(x_i - \\bar{x})(y_i - \\bar{y}) = 20 \\).`,
          itens: [
            { id: "A", enunciado: `a) Calcule o coeficiente de correlação de Pearson entre as horas de estudo e as notas finais. Interprete o resultado.`, resposta: `$$r = 1$$
<br><strong>Interpretação:</strong> O coeficiente \\( r = 1 \\) indica uma correlação linear positiva perfeita entre as horas de estudo e as notas.` },
            { id: "B", enunciado: `b) Com base no coeficiente calculado, é possível afirmar que estudar mais horas causa um aumento na nota? Justifique sua resposta.`, resposta: `Não. Apenas com a correlação estatística não podemos afirmar causa e efeito direto. Correlação não implica causalidade. Existem outras variáveis não observadas (qualidade do estudo, conhecimento prévio, etc.) que influenciam a nota.` }
          ]
        },
        {
          id: "LISTAP2-Q10",
